...
class Tehnika {
char* _naziv;
//int se odnosi na ocjenu u opsegu od 1 – 5, a Datum na datum kada je ocijenjena odredjena 
tehnika
...
COUT << obj.GetImePrezime() << " " << obj.GetEmail() << " " << obj.GetLozinka() << 
endl;
...
cout << "Pitanje -> Ukratko opisite redoslijed kreiranja objekta bazne klase u slucaju visestrukog nasljedjivanja(prilikom instanciranja objekta najizvedenije klase),"
"te koja su moguca rjesenja najznacajnijih problema u tom kontekstu ? \n";
return "Odgovor -> OVDJE UNESITE VAS ODGOVOR";
}
...
void main() {
    ...
    */
    ...
    Korisnik* lozinkaNijeValidna = new KaratePolaznik("John Doe", "john.doe@google.com",
        "johndoe");
    /*
